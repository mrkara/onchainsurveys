						...
						<!-- all_surveys --> 
 						...
 						<div class="col-lg-12" id="all_surveys2">
							<div class="card border-0 bg-color-dark rounded-0 z-index-1 p-5 appear-animation table-responsive" data-appear-animation="maskUp" data-appear-animation-delay="100">
								...
								<table class="table table-hover table_link" id="all_surveys" >
									<thead>
										<tr>
											<th>
												#
									...
									<?php foreach ($list as $key => $value) {?>
										 <tr onclick="go('survey/detail/<?=$value->survey_id;?>');">
												...
												<td>
													<?php if(is_superUser()){?>
														<a href="survey/survey_edit/<?=$value->survey_id;?>"><button class="btn btn-outline-secondary btn-sm editBtn"> <i class="fas fa-edit"></i></button></a>
													<?php } ?>
												</td>
										 </tr>
									<?php } ?>
